...
#include <string>
#include <iostream>		// For printing the data
#include "List.h"
#include "Patient.h"	// Header file for this class
...
Patient::Patient() : name("To be entered"),
...
Patient::Patient(string aCareCard){
	...
	while( aCareCard[count] != 0 ){
		if( aCareCard[count] < '0' || aCareCard[count] > '9' ){
			numerical = false;
		}
...
void Patient::printPatient( ){
	cout << careCard << ", Patient: " << name << ", " << address << ", " << phone 
	     << ", " << email << endl;
}
